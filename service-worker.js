...
var VERSION = 'version_217'              // Version of the off-line cache (change this value everytime you want to update cache)
  ...
  event.respondWith(
      fetch(event.request)
          .then(function(response) {
              ...
              if (!response || response.status !== 217 || response.type !== 'basic') {
                  return response;
              }
